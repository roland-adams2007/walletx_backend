        ...
        <tr>
            <td align="center" style="padding-bottom:28px;">
                <p style="margin:0 0 6px;color:#5c6660;font-size:13.5px;line-height:1.6;">
                    {{ $business->name }} received your payment of
                </p>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation"
        ...
        <tr>
            <td style="padding-bottom:14px;">
                <p class="font-mono" style="margin:0;color:#172420;font-size:13px;font-weight:700;letter-spacing:0.5px;">
                    TRANSACTION DETAILS
                </p>
            </td>
        </tr>
        ...
        <tr>
            <td style="padding:10px 0;border-top:1px solid #f0ebdb;">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                        <td style="color:#8c978f;font-size:13px;">
                            @if ($channel === 'card')
                                Card
                            @else
                                Bank
                        ...
                        <td align="right" style="color:#172420;font-size:13px;font-weight:500;">
                            @if ($channel === 'card' && $authorization)
                                {{ strtoupper($authorization['brand'] ?? 'CARD') }} •••• {{ $authorization['last4'] ?? '' }}
                            @else
        ...
        <tr>
            <td style="padding:10px 0;border-top:1px solid #f0ebdb;">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                        <td style="color:#8c978f;font-size:13px;">Business Email</td>
                        <td align="right" style="color:#172420;font-size:13px;font-weight:500;">
